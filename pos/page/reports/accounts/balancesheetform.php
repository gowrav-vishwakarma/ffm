<?php
class page_reports_accounts_balancesheetform extends page_reports {
	...
	function init(){
		...
		$form->addSubmit('Get Balance Sheet');
		...
		if($form->isSubmitted()){
			...
			$this->js()->univ()->redirect('reports_accounts_balancesheet',array('from_date'=>$form->get('from_date'),'to_date'=>$form->get('to_date')))->execute();
		}
	}
}