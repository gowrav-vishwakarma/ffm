...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tx-joomla-table">
	...
	<tr class="<?php if ($item->odd) { echo 'even'; } else { echo 'odd'; } ?>">
		...
		<td>
			...
			<?php if ( $this->params->get( 'show_link_description' ) ) : ?>
				<br /><span class="tx-description"><?php echo nl2br($this->escape($item->description)); ?></span>
			<?php endif; ?>
		</td>
		<?php if ( $this->params->get( 'show_link_hits' ) ) : ?>
		<td align="center">
