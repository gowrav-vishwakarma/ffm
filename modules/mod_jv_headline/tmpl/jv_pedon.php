...
$document->addStyleSheet(JURI::base() . 'modules/mod_jv_headline/assets/css/slideshow8.css');
$document->addScript(JURI::base() . 'modules/mod_jv_headline/assets/js/slideshow8.js');
